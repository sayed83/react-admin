...
class Header extends Component{
  ...
  <header className="main-header">
    ...
    <nav className="navbar navbar-static-top">
      ...
      <a href="_url" className="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div className="navbar-custom-menu">
        <ul className="nav navbar-nav">
          ...
          <li className="dropdown messages-menu">
            <a href="_url" className="dropdown-toggle" data-toggle="dropdown">
            ...
            <ul className="dropdown-menu">
              ...
              <li className="footer"><a href="_url">See All Messages</a></li>
            </ul>
          </li>
          ...
          <li className="dropdown notifications-menu">
            ...
            <ul className="dropdown-menu">
              ...
              <li className="footer"><a href="_url">View all</a></li>
            </ul>
          </li>
          ...
          <li className="dropdown user user-menu">
            ...
            <ul className="dropdown-menu">
              ...
              <li className="user-body">
                <div className="row">
                  <div className="col-xs-4 text-center">
                    <a href="_url">Followers</a>
                  </div>
                  <div className="col-xs-4 text-center">
                    <a href="_url">Sales</a>
                  </div>
                  <div className="col-xs-4 text-center">
                    <a href="_url">Friends</a>
                  </div>
                </div>
                {/* /.row */}
              </li>
              ...
              <li className="user-footer">
                <div className="pull-left">
                  <a href="_url" className="btn btn-default btn-flat">Profile</a>
                </div>
                <div className="pull-right">
                  <a href="_url" className="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
          ...
          <li>
            <a href="_url" data-toggle="control-sidebar"><i className="fa fa-gears" /></a>
          </li>
        </ul>
      </div>
    </nav>
